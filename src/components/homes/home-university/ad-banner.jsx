...
const AdBanner = () => {
    ...
    return (
        <div className="edu-cta-banner-area home-one-cta-wrapper bg-image" style={{ background: '#1a2e39'}}>
            <div className="container">
                <div className="edu-cta-banner">
                    <div className="row justify-content-center">
                        <div className="col-lg-7">
                            <div className="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <h2 className="title" style={{ color: '#fff', fontSize: '45px' }}>Get Your Market Oriented Skills <span style={{ color: '#DDA853'}}>With Us</span></h2>
                                <Link href="/course">
